...
Execute unit tests
```
    cd "SimpleShoppingCart.AwsLambda.ThirdPartyClient/test/SimpleShoppingCart.AwsLambda.ThirdPartyClient.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "SimpleShoppingCart.AwsLambda.ThirdPartyClient/src/SimpleShoppingCart.AwsLambda.ThirdPartyClient"
